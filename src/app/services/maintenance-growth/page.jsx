...
const offerings = [
  {
    ...
    text: "Keep your website secure, updated and running smoothly with ongoing technical maintenance.",
    tags: ["Updates", "Security", "Monitoring"],
  },
  {
    number: "02",
    title: "Application Support",
    text: "Continuous technical support to keep your applications reliable, stable and ready for everyday use.",
    tags: ["Support", "Bug Fixes", "Reliability"],
  },
  {
    number: "03",
    title: "Performance Optimization",
    text: "We identify bottlenecks and improve the speed, responsiveness and overall performance of your digital product.",
    tags: ["Speed", "Optimization", "Performance"],
  },
  {
    number: "04",
    title: "Security & Updates",
    text: "Regular updates and security-focused improvements help protect your digital systems as technology changes.",
    tags: ["Security", "Dependencies", "Protection"],
  },
  {
    number: "05",
    title: "Feature Improvements",
    text: "Keep your product moving forward with new features, refinements and improvements based on changing needs.",
    tags: ["Features", "Enhancements", "Iteration"],
  },
  {
    number: "06",
    title: "Long-Term Growth",
    text: "A continuous development partnership to evolve your digital presence as your business grows.",
    tags: ["Growth", "Scaling", "Continuous Development"],
  },
];
...
const process = [
  [
    "01",
    "Monitor",
    "We keep an eye on the health, performance and reliability of your digital systems.",
  ],
  [
    "02",
    "Maintain",
    "We handle updates, fixes and technical improvements before small issues become bigger problems.",
  ],
  [
    "03",
    "Improve",
    "We identify opportunities to make the product faster, cleaner and more useful.",
  ],
  [
    "04",
    "Grow",
    "We continuously add value through new features, improvements and long-term technical support.",
  ],
];

const faqs = [
  {
    q: "Why do I need ongoing maintenance?",
    a: "Digital products need regular updates, fixes, security improvements and optimization to remain reliable as technology and user needs change.",
  },
  {
    q: "Can you maintain a website you didn't build?",
    a: "Yes. We can review an existing website or application and take over its ongoing maintenance and improvement.",
  },
  {
    q: "Can maintenance include new features?",
    a: "Yes. Along with maintenance and support, we can continuously improve the product and add new features as your business evolves.",
  },
];

export default function MaintenanceGrowthPage() {
        ...
        <div className="mt-20 grid gap-12 lg:grid-cols-[1.4fr_0.6fr] lg:items-end">
          ...
          <div>
            ...
            <p className="mt-7 max-w-[520px] text-sm leading-7 text-white/45 sm:text-base">
              We keep your digital products secure, reliable and evolving
              through continuous maintenance, support and improvement.
            </p>
          ...
          <div className="max-w-sm pb-2 lg:justify-self-end">
            ...
            <div className="border border-white/[0.07] bg-white/[0.015] p-7">
              ...
              <p className="mt-6 text-sm leading-7 text-white/35">
                Ongoing support, optimization and development for products
        ...
        <div className="mx-auto grid max-w-[1400px] lg:grid-cols-[0.45fr_1fr]">
          ...
          <div className="px-6 py-10 lg:px-16 lg:py-14">
            ...
            <p className="max-w-4xl text-2xl leading-[1.45] tracking-[-0.02em] text-white/70 sm:text-3xl">
              Launching a product is only the beginning. We help you keep it
              <span className="text-white">
                {" "}healthy, relevant and ready for what comes next.
              </span>
            </p>
      ...
      <section className="mx-auto max-w-[1400px] px-6 py-24 lg:px-12 lg:py-32">
        ...
        <div className="mb-16 flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
          ...
          <p className="max-w-sm text-sm leading-6 text-white/35">
            Ongoing technical care and continuous improvements that keep your
        ...
        <div className="mx-auto grid max-w-[1400px] lg:grid-cols-2">
          ...
          <div className="min-h-[360px] border-b border-white/[0.08] p-8 lg:border-b-0 lg:border-r lg:p-14">
            ...
            <h2 className="mt-20 max-w-lg text-4xl font-medium leading-[1.05] tracking-[-0.04em] sm:text-5xl">
              Good products should keep getting better.
            </h2>
          ...
          <div className="flex min-h-[360px] items-end p-8 lg:p-14">
            ...
            <p className="max-w-xl text-xl leading-8 text-white/40 sm:text-2xl">
              Technology changes. Businesses change. Users change.
              Your digital product should be able to
              <span className="text-white">
                {" "}change with them.
              </span>
            </p>
